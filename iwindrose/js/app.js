      ...
      <div class="gallery-thumb is-video" style="--thumb-ratio:${ratio}" aria-label="${IPHONE_VIDEO.title}">
        ...
        <div class="gallery-video-wrap">
          <iframe id="vimeo-preview"
                  src="https://player.vimeo.com/video/${IPHONE_VIDEO.vimeoId}?badge=0&autopause=0&player_id=vimeo-preview&app_id=58479&loop=1&muted=1&autoplay=1"
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  /* Avvia il video Vimeo solo quando visibile */
  initVimeoObserver();
